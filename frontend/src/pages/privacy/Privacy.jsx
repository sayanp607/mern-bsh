...
import "./privacy.css"; // Assuming CSS is in Privacy.css
      ...
      <form className="privacy-form">
        <div className="privacy-text">
          <p>
            ...
            using the Service, as applicable. Company (referred to as either
            “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Bong
            Study Hub. Affiliate means an entity that controls, is controlled by
            ...
            to access our Service or parts of our Service. Website refers to
            Bong Study Hub, accessible from Bong Study Hub Service refers to the
            Website.
            <br /> Country refers to: Uttar Pradesh, India Service Provider
            ...
            account to use the Service. Personal Data is any information that
            relates to an identified or identifiable individual. <br />
            ...
            example, the duration of a page visit). <br /> Collecting and Using
            Your Personal Data Types of Data Collected Personal Data While using
            ...
            Service. Cookies can be “Persistent” or “Session” Cookies. <br />
            ...
            CookiesType: Session CookiesAdministered by: UsPurpose: These
            Cookies are essential to provide You with services available through
            the Website and to enable You to use some of its features. <br />{" "}
            ...
            language preference. <br /> The purpose of these Cookies is to
            provide You with a more personal experience and to avoid You having
            to re-enter your preferences every time You use the Website. For
            ...
            a user of the Service. <br /> The Personal Data You provide can give
            ...
            receive such information. <br /> To manage Your requests: To attend
            and manage Your requests to Us. We may share your personal
            information in the following situations: With Service Providers: We
            ...
            Service or for payment processing. For Business transfers: We may
            ...
            honor this Privacy Policy. <br /> Affiliates include Our parent
            ...
            distributed outside. <br /> If You interact with other users or
            ...
            You and view Your profile. Retention of Your Personal Data The
            ...
            retain Usage Data for internal analysis purposes. <br />
            ...
            data and other personal information. <br /> Disclosure of Your
            ...
            court or a government agency). Other legal requirements The Company
            ...
            storage is 100% secure. <br /> While We strive to use commercially
            ...
            has provided Us with Personal Data, please contact Us. <br /> If We
            ...
            between 13 and 18 years old. <br /> In some cases, this means We
            will be unable to provide certain functionality of the Service to
            these users. If We need to rely on consent as a legal basis for
            processing Your information and Your country requires consent from a
            parent, We may require Your parent’s consent before We collect and
            use that information. Links to Other Websites Our Service may
            contain links to other websites that are not operated by Us. <br />{" "}
            ...
            Privacy Policy. <br /> You are advised to review this Privacy Policy
